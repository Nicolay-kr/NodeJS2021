...
## This tool  encode and decode a text by 3 substitution ciphers:
...
2. git clone https://github.com/rolling-scopes-school/nicolay-kr-NODEJS2021Q4.git.

3. git checkout -b Task1/Ciphering-CLI-tool.
